...
{
    auto* client_seat = way_get_userdata<WayClientSeat>(wl_pointer);
    way_resource_create_refcounted(wp_cursor_shape_device_v1, client, cursor_shape_manager, id, client_seat);
}
