...
void gpu_init_functions(         GpuVulkanFunctions&, PFN_vkGetInstanceProcAddr);
void gpu_load_instance_functions(GpuVulkanFunctions&, VkInstance);
void gpu_load_device_functions(  GpuVulkanFunctions&, VkDevice);
