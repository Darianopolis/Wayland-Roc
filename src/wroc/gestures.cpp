...
{
    auto dummy = wl_resource_create(client, &zwp_pointer_gesture_swipe_v1_interface, wl_resource_get_version(resource), id);
    wroc_debug_track_resource(dummy);
...
{
    auto dummy = wl_resource_create(client, &zwp_pointer_gesture_pinch_v1_interface, wl_resource_get_version(resource), id);
    wroc_debug_track_resource(dummy);
...
{
    auto dummy = wl_resource_create(client, &zwp_pointer_gesture_hold_v1_interface, wl_resource_get_version(resource), id);
    wroc_debug_track_resource(dummy);
...
{
    auto dummy = wl_resource_create(client, &zwp_pointer_gestures_v1_interface, version, id);
    wroc_debug_track_resource(dummy);
