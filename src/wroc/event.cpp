...
static
void wroc_handle_event(const wroc_event& base_event)
{
    ...
    switch (wroc_event_get_type(base_event)) {
        ...
        case wroc_event_type::output_commit:
        ...
        case wroc_event_type::keyboard_modifiers:
            wroc_handle_keyboard_event(static_cast<const wroc_keyboard_event&>(base_event));
            break;

        case wroc_event_type::pointer_button:
        case wroc_event_type::pointer_motion:
        case wroc_event_type::pointer_axis:
            wroc_handle_pointer_event(static_cast<const wroc_pointer_event&>(base_event));
            break;
    }
}

void wroc_post_event(const wroc_event& base_event)
{
    wroc_handle_event(base_event);
}
